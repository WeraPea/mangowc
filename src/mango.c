...
static int32_t zoom_animating = 0;
static double zoom_center_x = 0.0f;
static double zoom_center_y = 0.0f;
static double zoom_move_grab_x = 0.0f;
static double zoom_move_grab_y = 0.0f;
...
skip:
	...
	// 如果需要更多帧，确保安排下一帧
	if (need_more_frames || zoom_animating) {
